    ...
    <main>
          ...
          <div id="home-slider2" className="rev_slider" data-version={5.0}>
            <ul>
              ...
              >
                ...
                >
                  The weather started getting rough is the tiny ship was tossed.
                  If not for
      ...
      <div id="deal" className="dealing-section container-fluid no-padding">
        ...
        <div className="col-md-6 col-sm-12 col-xs-6 saleup-img">
          ...
          <h5>mens casual shoes</h5>
          <p>
            The weather started getting rough the tossed. If not for the courage
            of the fearless crew the Minnow would be lost. would be lost.{" "}
          </p>
              ...
              <div className="item active">
                <div className="testimonial-content">
                  ...
                  <p>
                    ...
                    ain't nothin' Beats all you've ever saw been in trouble with
                    the law since the day.{" "}
                  </p>
                ...
                <div className="col-md-7 col-sm-12 col-xs-12 blog-content">
                  ...
                  <div className="entry-content">
                    <p>
                      ...
                      tossed. If not for the courage of the fearless If not for
                      the courage of the Minnow would be lost.
                    </p>
                    <a
                      href="blog-post.html"
                      title="Read More"
