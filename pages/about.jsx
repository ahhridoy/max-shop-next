          ...
          <div className="container">
            ...
            <div className="col-md-6 col-sm-6 col-xs-6">
              <div className="about-content">
                <h5>
                  When you shop on <span>max shop</span> you can assured about
                  the quality of the products you're buying.
                </h5>
                <p>
                  You wanna be where you can see our troubles are all the same.
                  You wanna be where everybody knows Your name. So lets make the
                  most of this beautiful day. Since we're together. , We're
                  gonna do it. On your mark get set and go now.
                </p>
                <p>
                  Makin their way the only way they know how. That's just a
                  little bit more than the law will allow. Doin' it our way.{" "}
                </p>
                <ul>
            ...
            <div className="col-md-3 col-sm-4 col-xs-6">
              <div className="team-detail">
                ...
                <div className="team-content">
                  <h5>Web Designer</h5>
                  <p>
                    Believe it or not I'm walking on air.on a wing and a prayer.
                  </p>
                  <ul className="social">
                    <li>
