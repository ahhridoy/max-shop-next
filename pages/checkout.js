            ...
            <div className="col-md-12 col-sm-12 col-xs-12 login-block">
              <div className="login-check">
                ...
                <div className="col-md-5 col-sm-6 col-xs-6 check-details">
                  ...
                  <div className="check-detail">
                    <a href="#" title="continue" className="continue">
                      Continue
                    </a>
                  </div>
                </div>
              ...
              <form>
                <div className="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div className="form-group col-md-12 col-sm-12 col-xs-12 woocommerce-info">
                    ...
                    <a href="#" className="fb" title="Facebook">
                      <i className="fa fa-facebook-square" />
                    </a>
                    <a href="#" className="gp" title="Facebook">
                    ...
                    <div className="checkout-payment">
                      <ul>
                        ...
                        <li>
                          ...
                          <label>
                            Paypal <img src="images/paypal.jpg" alt="Paypal" />
                          </label>
                        </li>
                      </ul>
                    </div>
