        ...
        <div className="container">
          <div className="product-views">
            ...
            <div className="col-md-6 col-sm-6 col-xs-12 entry-summary">
              ...
              <div>
                <p>
                  So this is the tale of our castaways they're here for a long
                  long time. They'll have to make the best of things its an
                  uphill climb. Now were up in the big leagues getting' our turn
                  at bat.
                </p>
              </div>
              ...
              <form>
                ...
                <div className="product-quantity" data-title="Quantity">
                  ...
                  <input
                    type="button"
                    defaultValue="+"
                    className="qtyplus btn"
                    data-field="quantity1"
                  />
                </div>
                <button title="Add To Cart" className="add_to_cart">
                  Add To Cart
                </button>
              </form>
          ...
          <div className="col-md-12 col-sm-12 col-xs-12 description">
            ...
            <p>
              ...
              exist. And we'll do it our way yes our way. Make all our dreams
              come true for me and you. Makin their way the only way they know
              how. That's just a little bit more than the law will allow. Doin'
              it our way. Nothin's gonna turn us back now. Straight ahead and on
              the track now. We're gonna make our dreams come true Takin' a
              break from all your worries sure would help a lot. Believe it or
              not I'm walking on air. I never thought I could feel so free.
              Flying away on a wing and a prayer. Who could it be? Believe it or
              not its just me.{" "}
            </p>
          </div>
          {/* Product Section */}
