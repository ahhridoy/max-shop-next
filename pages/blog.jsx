        ...
        <div className="container">
          ...
          <div className="content-area blog-section col-md-8 col-sm-8 col-xs-12">
            ...
            <div className="type-post">
              ...
              <div className="col-md-7 col-sm-12 col-xs-12 blog-content">
                <h3 className="entry-title">
                  <a title="Our shop visitor's new look" href="blog-post.html">
                    Our shop visitor's <span>new look</span>
                  </a>
                </h3>
                <div className="entry-meta">
                  <span className="post-like">
                    <a href="#" title="145 Likes">
                      <i className="fa fa-heart-o" />
                      145 Likes
                    </a>
                  </span>
            ...
            <div className="type-post">
              ...
              <div className="col-md-7 col-sm-12 col-xs-12 blog-content">
                <h3 className="entry-title">
                  <a
                    title="Happy Customers enjoying in the street"
                    href="blog-post.html"
                  >
                    Happy Customers <span>enjoying</span> in the street
                  </a>
                </h3>
                <div className="entry-meta">
                  <span className="post-like">
                    <a href="#" title="230 Likes">
                      <i className="fa fa-heart-o" />
                      230 Likes
                    </a>
                  </span>
