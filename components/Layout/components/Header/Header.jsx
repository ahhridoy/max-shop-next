                    ...
                    <ul className="dropdown-menu no-padding">
                      <li className="mini_cart_item">
                        ...
                        <span className="quantity">
                          2 × <span className="amount">Rs.12.00</span>
                        </span>
                      </li>
                      <li className="mini_cart_item">
                        <a title="Remove this item" className="remove" href="#">
                        ...
                        <a href="#" className="shop-thumbnail">
                          <img
                            alt="poster_2_up"
                            className="attachment-shop_thumbnail"
                            src="images/product-wishlist-2.jpg"
                          />
                          Flying Ninja
                        </a>
                        <span className="quantity">
                ...
                <ul className="nav navbar-nav">
                  <li className="active dropdown">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <a href="index.html" title="home 1">
                          home 1
                        </a>
                      </li>
                      <li>
                        <a href="index2.html" title="home 2">
                          home 2
                        </a>
                      </li>
                    </ul>
                  ...
                  <li>
                    <a href="#product-section" title="Products">
                      Products
                    </a>
                  </li>
                  <li className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <a href="shop-single.html" title="Shop Single">
                          Shop Single
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <a href="blog-post.html" title="Blog Post">
                          Blog Post
                        </a>
                      </li>
                    </ul>
